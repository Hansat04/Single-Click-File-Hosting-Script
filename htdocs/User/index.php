    ...
    <div class="container">
        ...
        <table>
            ...
            foreach ($files as $file) : ?>
                <tr>
                    <td><?php echo $file; ?></td>
                    <td><a class="download" href="../download.php?filename=<?php echo urlencode($file); ?>" target="_blank">Herunterladen</a></td>
                    <td>
                        <?php if ($file !== 'delete.php') : ?>
                            <button class="delete-button" data-filename="<?php echo $file; ?>" data-action="delete-file">Löschen</button>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        ...
        <div class="logout">
            ...
            <form id="deleteForm" action="delete_account.php" method="post">
                ...
                <button class="delete-button delete-account-btn" type="button" data-action="delete-account">Konto löschen</button>
            </form>
        </div>
    </div>
</main>
...
<script>
    ...
    document.querySelectorAll('.delete-button, .delete-account-btn').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            if (confirm('Sind Sie sicher, dass Sie ' + (filename ? filename : 'Ihr Konto') + ' löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.')) {
